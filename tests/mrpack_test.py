...
from mrpack_utils.mrpack import File, Hashes, Index, Mrpack, MrpackError, Override, _validated_path
...
class TestValidatedPath:
    def test_validated_path(self) -> None:
        assert _validated_path("a") == PurePath("a")
        assert _validated_path("a/b") == PurePath("a", "b")
        assert _validated_path("a/./b") == PurePath("a", "b")
